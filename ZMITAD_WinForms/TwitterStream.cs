...
namespace ZMITAD_WinForms
{
    ...
    public class TwitterStream : OAuthBase
    {
        ...
        private MojDataStore mojDataStore;

        public void Stream2Queue(MojDataStore ds)
        {
            this.mojDataStore = ds;
                    ...
                    try
                    {
                        ...
                        while (true)
                        {
                            ...
                            else
                            {
                                ...
                                byte[] byteArray = Encoding.UTF8.GetBytes(jsonText.ToString());
